...
const Footer = () => {
  ...
  return (
    <footer className="bg-linear-to-br from-primary-900 to-primary-800 text-white mt-auto">
          ...
          >
            ...
            <ul className="space-y-3">
              <li className="flex items-start space-x-2">
                ...
                <span className="text-primary-200">Bhaktapur, Nepal</span>
              </li>
              <li className="flex items-center space-x-2">
                <Phone className="w-5 h-5 text-primary-400" />
                <span className="text-primary-200">9745969254</span>
              </li>
              <li className="flex items-center space-x-2">
                <Mail className="w-5 h-5 text-primary-400" />
                <span className="text-primary-200">info@bookshell.com</span>
              </li>
            </ul>
          </motion.div>
